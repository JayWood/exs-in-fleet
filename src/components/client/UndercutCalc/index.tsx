    ...
    <div className="card card-border bg-base-100 card-md shadow-sm">
      <div className="card-body">
        <div className="flex justify-between items-center">
          ...
          <div>
            <button className="btn btn-link mb-2 px-0" onClick={() => null}>
        ...
        <div className="overflow-x-auto px-4 py-2">
          <div className="form-control mb-4">
            ...
            <input
              ...
              min="0"
            />
            <span className="secondary text-gray-200 text-xs">
              Enter a percentage to undercut market orders by that amount
            </span>
          </div>
          ...
          <div className="form-control">
            ...
            <textarea
              ...
              onChange={e =>
                setOrders(
                  parseMarketOrderPaste(e.target.value, undercutPercentage)
                )
              }
            ></textarea>
          </div>
                  ...
                  {orders.map((order, index) => (
                    <Item
                      ...
                      onChange={v => {
                        ...
                        newOrders[index].netPrice =
                          newOrders[index].price * (1 - v / 100)
                        setOrders(newOrders)
                      }}
                    />
                  ))}
